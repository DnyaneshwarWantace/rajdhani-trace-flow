...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-semibold break-words whitespace-pre-wrap", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-sm opacity-90 break-words whitespace-pre-wrap max-h-40 overflow-y-auto pr-1", className)}
    {...props}
  />
))
