                      ...
                      <div className="flex items-center gap-3">
                        {product.image_url ? (
                          <img
                            ...
                            className="w-10 h-10 rounded-lg object-contain object-center flex-shrink-0 bg-white border border-gray-200 cursor-pointer hover:opacity-80 transition-opacity"
                          />
                        ) : (
