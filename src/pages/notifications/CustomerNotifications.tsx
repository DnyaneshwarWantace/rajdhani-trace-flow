...
export default function CustomerNotifications() {
  ...
  const loadData = async () => {
    try {
      ...
      // Filter for customer-related notifications
      const customerNotifications = data.filter(n => 
      ...
      const regularNotifications = customerNotifications.filter(n => !n.related_data?.activity_log_id);
      const logs = customerNotifications.filter(n => n.related_data?.activity_log_id);
  ...
  const handleNotificationClick = (notification: Notification) => {
    if (notification.related_id) {
      navigate(`/customers/${notification.related_id}`);
    }
  };
    ...
    <Layout>
      <div>
        <SectionHeader
          ...
          description="View all customer related notifications and logs"
